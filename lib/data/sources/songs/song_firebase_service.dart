...
import 'package:spotify_clone/data/model/song/song.dart';
  ...
  Future<Either> getNewsSongs() async {
    try {
      ...
      for (var element in data.docs) {
        ...
        bool isFavorite = await sl<IsFavoriteSongsUseCase>()
      ...
      return const Left('An error occured,Please try agin');
    }
  }
